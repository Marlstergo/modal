                ...
                <div className="flex flex-wrap ">
                  <div  className="w-6/12">
                    <div className="mr-6">
                      ...
                      <select
                        name="language"
                        className="hidden md:block w-full text-sm outline-none border-2 focus:outline-none focus:ring-0"
                        id=""
                      >
                  ...
                  <div className="w-6/12">
                    <div className="mr-6">
                      ...
                      <select
                        name="language"
                        className="hidden md:block w-full text-sm outline-none border-2 focus:outline-none focus:ring-0 divide-solid divide-y-2"
                        id=""
                      >
