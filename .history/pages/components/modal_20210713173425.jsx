            ...
            <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
              ...
              <div className="mt-2 w-full">
                ...
                <div className="my-6 w-full flex flex-col">
                  ...
                  <select
                    name="language"
                    className=" w-1/2  text-sm outline-none border-0 focus:outline-none focus:ring-0"
                    id=""
                  >
                ...
                <div className="flex flex-wrap ">
                  <div  className="w-6/12">
                    <div className="mr-6">
                      ...
                      <select
                        name="language"
                        className="hidden md:block w-full text-sm outline-none border-0 focus:outline-none focus:ring-0"
                        id=""
                      >
                  ...
                  <div className="w-6/12">
                    <div className="mr-6">
                      ...
                      <select
                        name="language"
                        className="hidden md:block w-full text-sm outline-none border-0 focus:outline-none focus:ring-0 divide-solid divide-y-2"
                        id=""
                      >
                ...
                <div className="w-full pt-6 mr-10  pt-">
                  ...
                  <input
                    className="  shadow-md rounded-lg w-full mt-2 h-10  bg-white  outline-none border-0 focus:border-0 focus:border-current focus:outline-none text-base 
                  focus:ring-0
